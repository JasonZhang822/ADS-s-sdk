import { p as _, s as x, a as v, r as E, C as c, O as C, i as I, c as m, b as y, A as u, x as A, d as b, E as d, W as p, S as h, e as T, M as N, R as O } from "./index-W1x9Ryk5.mjs";
import { f as P, V as z, Y as D } from "./index-W1x9Ryk5.mjs";
const i = _({
...
var U = function(t, e, n, a) {
  ...
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function") s = Reflect.decorate(t, e, n, a);
  else for (var l = t.length - 1; l >= 0; l--) (o = t[l]) && (s = (r < 3 ? o(s) : r > 3 ? o(e, n, s) : o(e, n)) || s);
...
let w = class extends y {
  ...
  async onSign() {
    ...
    this.isSigning = !0, d.sendEvent({
      ...
      type: "track",
      properties: {
        network: ((e = c.state.activeCaipNetwork) == null ? void 0 : e.caipNetworkId) || "",
        isSmartAccount: u.state.preferredAccountType === p.ACCOUNT_TYPES.SMART_ACCOUNT
      }
    });
    try {
      g.setStatus("loading");
      const r = await g.signIn();
      return g.setStatus("success"), d.sendEvent({
        event: "SIWE_AUTH_SUCCESS",
        type: "track",
        properties: {
          network: ((n = c.state.activeCaipNetwork) == null ? void 0 : n.caipNetworkId) || "",
          isSmartAccount: u.state.preferredAccountType === p.ACCOUNT_TYPES.SMART_ACCOUNT
        }
      }), r;
    } catch {
      const o = u.state.preferredAccountType === p.ACCOUNT_TYPES.SMART_ACCOUNT;
      return o ? h.showError("This application might not support Smart Accounts") : h.showError("Signature declined"), g.setStatus("error"), d.sendEvent({
        event: "SIWE_AUTH_ERROR",
        type: "track",
        properties: {
          network: ((a = c.state.activeCaipNetwork) == null ? void 0 : a.caipNetworkId) || "",
          isSmartAccount: o
        }
      });
    } finally {
  ...
  async onCancel() {
    var n;
    this.isCancelling = !0, c.state.activeCaipAddress ? (await T.disconnect(), N.close()) : O.push("Connect"), this.isCancelling = !1, d.sendEvent({
