import { i as v, b as y, M as r, C as h, O as f, aN as C, A as p, E as k, x as S, R as c, U as x, j as A, S as E, aO as b, aP as N, d as w, c as O, aQ as L } from "./index-W1x9Ryk5.mjs";
const K = v`
  :host {
...
let l = class extends y {
  ...
  async handleClose() {
    ...
    if (this.isSiweEnabled) {
      const { SIWEController: i } = await import("./index-DcmbQffm.mjs");
  ...
  async onNewAddress(e) {
    var n;
    const t = this.caipAddress, i = t ? b.getPlainAddress(t) : void 0, o = e ? b.getPlainAddress(e) : void 0, s = i === o;
    if (this.caipAddress = e, o && !s && this.isSiweEnabled)
      try {
        const { SIWEController: a } = await import("./index-DcmbQffm.mjs"), m = p.state.siweStatus === "success";
        !i && o ? this.onSiweNavigation() : m && i && o && i !== o && (n = a.state._client) != null && n.options.signOutOnAccountChange && (await a.signOut(), this.onSiweNavigation());
      } catch (a) {
  ...
  async onNewNetwork(e) {
    ...
    const t = (s = (o = this.caipNetwork) == null ? void 0 : o.caipNetworkId) == null ? void 0 : s.toString(), i = (n = e == null ? void 0 : e.caipNetworkId) == null ? void 0 : n.toString();
    if (t && i && t !== i)
      if (this.isSiweEnabled) {
        const { SIWEController: m } = await import("./index-DcmbQffm.mjs");
